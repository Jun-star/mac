...
//>>>>>>>>>>>>>>>>>>>第一行单元格>>>>>>>>>>>>>>>>>>
       ...
       // [button setTitle:@"Yes" forState:UIControlStateNormal];
        ...
        UILabel *label1=[[UILabel alloc] initWithFrame:CGRectMake(180, 90,60, 30)];
        [label1 setText:@"688.00"];
        
        [self addSubview:label1];
        UILabel *label2=[[UILabel alloc] initWithFrame:CGRectMake(180, 120, 200, 30)];
        [label2 setText:@"市场价：888.00"];
